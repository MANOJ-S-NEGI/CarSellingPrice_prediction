...
def csv_path():
    try:
        CSV_PATH_ROOT = 'model_dir/DBScan.joblib'
    except FileNotFoundError:
        CSV_PATH_ROOT = "D:/msn/pycharm_projects/firsthosting/csv_dir/car_dekho_clean.csv"
...
def load_cluster_model():
    try:
        ...
        CLUSTER_MODEL_PATH_ABS = 'D:/msn/pycharm_projects/firsthosting/model_dir/DBScan.joblib'
...
def load_xgboost_model():
    try:
        ...
        XGBOOST_MODEL_PATH_ABS = 'D:/msn/pycharm_projects/firsthosting/model_dir/model_Xgboost.joblib'
...
def load_feature_selection_model():
    try:
        ...
        FEATURE_SELECTION_MODEL_PATH_ABS = 'D:/msn/pycharm_projects/firsthosting/model_dir/random_forest_feature_selection.joblib'
